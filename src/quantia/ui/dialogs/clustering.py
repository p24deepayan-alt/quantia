    ...
    def generate_code(self):
        ...
        if plots_to_draw:
            ...
            if self.chk_dendrogram.isChecked() and self._supports_dendrogram:
                ...
                code.append("")
                code.append("    plot_dendrogram_internal(model, truncate_mode='level', p=5, ax=axes[ax_idx])")
            ...
            code.append("    html_output += f'<div style=\"margin-top:24px; text-align:center;\"><img src=\"data:image/png;base64,{img_b64}\" style=\"max-width:100%; border:1px solid #E2E8F0; border-radius:4px;\"/></div>'")
