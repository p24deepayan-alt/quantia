...
class NonParametricDialog(BaseAnalysisDialog):
    ...
    def generate_code(self) -> str:
        ...
        code += [
            ...
            "    bg_color = '#F0FDF4' if p < 0.05 else '#FEF2F2'",
            "    border_color = '#22C55E' if p < 0.05 else '#EF4444'",
            "    ",
            "    html += f'<div style=\"padding:12px 16px; background:{bg_color}; border-left:4px solid {border_color}; border-radius:4px; margin-bottom:20px;\">'",
